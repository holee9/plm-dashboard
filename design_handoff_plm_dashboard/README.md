...
- **Projects 8:5 그리드:** Projects 뷰는 황금비(φ≈1.618)의 실무 근사인 `8fr / 5fr` 레이아웃. 좌측 주 영역은 과제 헤더 + Work Packages 테이블, 우측 보조 영역은 KPI 레일 + Team + Status + Burndown 순서. Desktop 1440px 실측 기준 컬럼 비율 721:451=1.600, 12px 줄 단위 높이 `276 + 12 + 696`으로 좌우 시작선·하단선 정렬
