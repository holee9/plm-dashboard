...
- **Projects 8:5 그리드:** Projects 뷰는 황금비(φ≈1.618)의 실무 근사인 `8fr / 5fr` 레이아웃. 좌측 주 영역은 과제 헤더 + Work Packages 테이블, 우측 보조 영역은 KPI 레일 + Team + Status + Burndown 순서. Playwright 실측 기준 desktop 1440px에서 컬럼 비율 721:451=1.600, Work Packages 시작 y=433px
